...
public class EnvironmentTranslatorTest extends
    ...
    protected EnvironmentContentTranslatorTest envContTranslatorTest = new EnvironmentContentTranslatorTest();

    @Override
    protected void initModelTranslator(ModelTranslator modelTranslator) {
        ownerTranslatorTest.initModelTranslator(modelTranslator);
        envContTranslatorTest.initModelTranslator(modelTranslator);
    ...
    protected Environment initSourceObject() {
        ...
        for (int i = 0; i < 5; ++i) {
            EnvironmentContent environmentContent = envContTranslatorTest.initSourceObject();
            environmentContent.setId("envContent-" + i);
