...
public class ConsumerResourceUpdateTest {
    ...
    public void init() throws Exception {
        ...
        this.resource = new ConsumerResource(this.consumerCurator,
            ...
            null, null, new FactValidator(config, this.i18n), null, consumerEnricher, translator);
    ...
    public void testUpdateConsumerUpdatesGuestIds() {
        ...
        verify(consumerCurator, times(1)).update(consumerArgumentCaptor.capture());
        Consumer mergedConsumer = consumerArgumentCaptor.getValue();
